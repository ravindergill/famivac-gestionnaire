...
create table INFORMATIONS_HABITATION (id int8 not null, AUTRES_ANIMAUX varchar(1000), JARDIN_ESCPACE_JEU boolean, NOMBRE_ANIMAUX int4, NOMBRE_CHATS int4, NOMBRE_CHIENS int4, PISCINE boolean, PISCINE_SECURISE boolean, POINT_VIGILANCE varchar(1000), SITUATION_HABITATION varchar(255), TYPE_HABITATION varchar(255), VILLE_LA_PLUS_PROCHE varchar(255), FAMILLE_ID int8 not null, primary key (id))
...
create table Sejour (id int8 not null, dateDebut date, dateFin date, dateFinReelle date, tarif int4 not null, aller_id int8, enfant_id int8, famille_id int8, retour_id int8, primary key (id))
